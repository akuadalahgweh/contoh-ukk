...
<body>
    ...
    <section style="min-height: 200px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="py-2 mt-3">Kelola Data Anggota 👥</h1>
                    <a href="tambah_anggota.php" class="btn btn-secondary mb-3 mt-2"> ➕ Tambah Data Anggota</a>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="edit_anggota.php?id_anggota=<?php echo $anggota['id_anggota'] ?>" class="btn btn-warning">🖊️Edit</a>
