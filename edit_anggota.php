                ...
                <div class="col-md-12">
                    ...
                    <form action="simpan_edit_anggota.php" method="POST">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="nis" value="<?php echo $anggota['nis']; ?>">
                        </div>
                        <div class="col-md-3">
                            <label for="text" class="form-label">Username</label>
                            <input type="text" class="form-control" name="username" value="<?php echo $anggota['username'] ?>">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="kelas" value="<?php echo $anggota['kelas'] ?>">
                        </div>
                        <div class="mb-3">
